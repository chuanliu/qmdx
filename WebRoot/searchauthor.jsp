...
<body background="images/login_bg.jpg">
    根据作者查找<br>
    <s:form action="seacrch.action" method="post">
    <s:label>请输入您要查找的作者</s:label>  
    <s:fielderror></s:fielderror>
    <s:textfield name="author" id="nameid"></s:textfield>
    <s:submit value="查找" onclick="checkname()"></s:submit>  
<table>
<tr>
<td width="80">
